...
Épicas → `docs/03-backlog/`. Historias de usuario → `docs/04-historias/`. Flows → `docs/06-flows-e2e/`.
...
- Revisión automática: agente `prd-reviewer`, invocable vía `/factory-product-revisar`.
