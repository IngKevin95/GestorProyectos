...
Reglas locales para historias de usuario y sus AC. Detalle completo en `METODOLOGIA.md` §3 y §5.

## Fuera de alcance aquí

Épicas → `docs/03-backlog/`. Sesiones de priorización → `docs/03-backlog/`. Flows → `docs/06-flows-e2e/`.
