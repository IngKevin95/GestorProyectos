...
Reglas locales para épicas y backlog. Detalle completo en `METODOLOGIA.md` §2 y §7.
...
3. Este directorio no prioriza — la priorización se decide en `docs/03-backlog/` y aquí solo se refleja el resultado.
